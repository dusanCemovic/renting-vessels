<x-layout title="Add Equipment">
    ...
    <form method="POST" action="{{ route('equipments.store') }}" class="mt-6 max-w-xl space-y-4">
        ...
        <div>
            ...
            <input name="code" value="{{ old('code') }}" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500" />
        </div>
        <div>
        ...
        <div>
            ...
            <textarea name="description" rows="3" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description') }}</textarea>
        </div>
